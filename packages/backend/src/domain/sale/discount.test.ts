...
describe('Discount Value Object', () => {
  describe('createDiscount', () => {
    describe('PERCENTAGE discount', () => {
      ...
      it('should reject NaN percentage', () => {
        const result = createDiscount({ type: 'PERCENTAGE', value: Number.NaN })
      ...
      it('should reject Infinity percentage', () => {
        const result = createDiscount({ type: 'PERCENTAGE', value: Number.POSITIVE_INFINITY })
    ...
    describe('AMOUNT discount', () => {
      ...
      it('should reject Infinity amount', () => {
        const result = createDiscount({ type: 'AMOUNT', value: Number.POSITIVE_INFINITY })
  ...
  describe('type guards', () => {
    it('should distinguish between percentage and amount discounts', () => {
      const percentageResult = createDiscount({ type: 'PERCENTAGE', value: 10 })
