...
export type CustomerRepository = {
   ...
   */
  readonly save: (customer: Customer) => Promise<Result<Customer, RepositoryError>>
   ...
   */
  readonly findById: (id: CustomerId) => Promise<Result<Customer, RepositoryError>>
   ...
   * @returns Result with Customer or NOT_FOUND error
   */
  readonly findByCPF: (cpf: string) => Promise<Result<Customer, RepositoryError>>
   ...
   * @returns Result with Customer or NOT_FOUND error
   */
  readonly findByEmail: (email: string) => Promise<Result<Customer, RepositoryError>>
}
