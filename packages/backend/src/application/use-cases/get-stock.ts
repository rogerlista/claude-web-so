...
import type { InventoryRepository, RepositoryError, StockInfo } from '../ports/inventory-repository'
 ...
 */
export type GetStockUseCase = (input: GetStockInput) => Promise<Result<StockInfo, GetStockError>>
