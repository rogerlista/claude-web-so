...
describe("BaseAlert", () => {
	...
	describe("Variants", () => {
		it("should apply info variant by default", () => {
			const wrapper = mount(BaseAlert);
			expect(wrapper.find(".base-alert").classes()).toContain(
				"base-alert--info",
			);
		});
	...
	describe("Bordered", () => {
		it("should not have border by default", () => {
			const wrapper = mount(BaseAlert);
			expect(wrapper.find(".base-alert").classes()).not.toContain(
				"base-alert--bordered",
			);
		});
	...
	describe("Accessibility", () => {
		...
		it('should have aria-live="polite" by default', () => {
			const wrapper = mount(BaseAlert);
			expect(wrapper.find(".base-alert").attributes("aria-live")).toBe(
				"polite",
			);
		});
		...
		it("should have aria-label on close button", () => {
			...
			expect(
				wrapper.find(".base-alert__close").attributes("aria-label"),
			).toBeDefined();
		});
	});
	...
	describe("Close Button Label", () => {
		it("should have default close label", () => {
			...
			expect(wrapper.find(".base-alert__close").attributes("aria-label")).toBe(
				"Fechar alerta",
			);
		});
