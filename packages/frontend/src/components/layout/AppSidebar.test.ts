...
describe('AppSidebar', () => {
  ...
  describe('Open/Closed State', () => {
    it('should be closed by default', () => {
      const wrapper = mount(AppSidebar)
      expect(wrapper.find('.app-sidebar').classes()).not.toContain('app-sidebar--open')
    })
    ...
    it('should be open when open prop is true', () => {
      ...
      expect(wrapper.find('.app-sidebar').classes()).toContain('app-sidebar--open')
    })
  ...
  describe('Active Item', () => {
    it('should not have active item by default', () => {
      ...
      expect(wrapper.find('.app-sidebar__menu-item--active').exists()).toBe(false)
    })
    ...
    it('should not mark other items as active', () => {
      ...
      const items = wrapper.findAll('.app-sidebar__menu-item')
      expect(items[0]?.classes()).not.toContain('app-sidebar__menu-item--active')
      expect(items[2]?.classes()).not.toContain('app-sidebar__menu-item--active')
    })
  })
