...
async function main(): Promise<void> {
  ...
  log('This validator ensures you are following TDD best practices:', COLORS.yellow)
  ...
  if (allPassed) {
    ...
    log('Your code follows TDD best practices and is ready to commit.', COLORS.green)
    process.exit(0)
  } else {
